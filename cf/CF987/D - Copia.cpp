...
void solve(){
	...
	for(auto [x_, v] : pos){
		...
		for(int i : v){
			cout << i << ": " << seg1::query(1, 1, n, i, i) << " " << seg2::query(1, 1, n, i, i) << endl;
			ans[i] = max(seg1::query(1, 1, n, i, i), seg2::query(1, 1, n, i, i));
			seg2::update(1,1,n,1,i,ans[i]);
		}
	}
